...
class Marquee extends StatefulWidget {
  ...
  final List<TextSpan> richtexts;

  /// The texts total length.
  final double textsLength;
  ...
  bool equals(Object other) {
    return other is Marquee
        && richtexts == other.richtexts
        && textsLength == other.textsLength
        && style == other.style
  ...
  Widget build(BuildContext context) {
    return ListView.builder(
        ...
        itemBuilder: (_, i) {
          ...
          return i.isEven ? RealRichText(widget.richtexts) : _buildBlankSpace();
        }
    );
  }
